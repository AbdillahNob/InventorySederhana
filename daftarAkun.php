...
<head>
    ...
    <title>Inventory Marina R</title>
    <!-- Favicon icon -->
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action="?noFile=1" method="POST">
                                    ...
                                    <button class="btn login-form__btn submit w-100" name="submit">Daftar</button>
                                </form>
                                <p class="mt-5 login-form__footer">Sudah Punya Akun? <a href="index.php"
